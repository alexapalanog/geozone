...
const RewardNoticeView: React.FC<{ onReturn: () => void }> = ({ onReturn }) => {
  return (
    <div 
    ...
    >
      ...
      <div className="relative bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-8 max-w-sm w-full animate-pop-in">
        <h1 className="text-2xl font-bold text-blue-800">A Quick Note</h1>
        <p className="mt-3 text-gray-700">
            You'll be directed to the GlobeOne app to finalize your Gokenzone points. You can return to the app's home screen at any time.
        </p>
        <button
            onClick={onReturn}
...
export default RewardNoticeView;