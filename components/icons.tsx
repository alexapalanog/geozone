...
export const GlobeOneLogoIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg 
        viewBox="0 0 100 100" 
        xmlns="http://www.w3.org/2000/svg"
        className={className}
    >
        <g fill="none" strokeWidth="9">
            {/* Middle light blue circle */}
            <circle cx="50" cy="50" r="28" stroke="#3b82f6" />

            {/* Outer dark blue arc */}
            <path d="M 85 62 A 38 38 0 1 0 50 12" stroke="#1e40af" />
            
            {/* Outer red arc */}
            <path d="M 50 12 A 38 38 0 0 1 85 38" stroke="#dc2626" />
        </g>
        
        {/* The two dots */}
        <g fill="#1e40af">
          <circle cx="85" cy="62" r="4.5" />
